...
async def test_prompt_async(
    ...
    """
    Asynchronously test a prompt with retry logic and optional connection pooling (Phase 2).
    ...
    for attempt in range(max_retries):
        try:
            if connection_reuse:
                ...
                # Get the prompt using persistent connection
                result = await persistent_client.get_prompt(prompt_name, prompt_arguments)
